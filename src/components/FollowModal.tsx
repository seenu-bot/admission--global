  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const payload = {
        ...
        action: type === "job" ? "job_follow" : "internship_follow",
      ...
      setSubmitStatus(`Thank you! You're now following ${jobTitle || "this position"}. We'll notify you about updates.`);
          ...
          <div className="p-6">
            ...
            <div className="mb-6">
              <h2 className="text-2xl font-bold text-gray-900 mb-3">
                Follow {type === "job" ? "Job" : "Internship"}
              </h2>
              {jobTitle && (
              ...
              <p className="text-sm text-gray-600">
                Get notified about updates and new opportunities. Fill in your details below to follow this position.
              </p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              {submitStatus && (
                <div
                  className={`p-3 rounded-lg text-sm ${
                    submitStatus.includes("Thank you") || submitStatus.includes("following")
              ...
              >
                {isSubmitting ? "Submitting..." : "Follow"}
              </button>
            </form>
          </div>
        </div>
